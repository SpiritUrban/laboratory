...
const modelurl = './src/3d/alien.gltf';
...
// // Завантажимо 3D-модель
// const loader = new GLTFLoader();
// loader.load('./src/3d/alien.gltf', function(gltf) {
...
// // loader.load('my_model.obj', function(object) {
// //   scene.add(object);
// // }, undefined, function(error) {
// //   console.error(error);
// // });

// // Створимо функцію анімації
// function animate() {
//   requestAnimationFrame(animate);
//   renderer.render(scene, camera);
// }
